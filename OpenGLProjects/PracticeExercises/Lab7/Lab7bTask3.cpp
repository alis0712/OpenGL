/*  animation2.c   This programs draws a simple Solar system that animates
    constantly
    Jie Yan Nov 4. 2015

    Try:

    Task1: make the whole Solar System roating in Y direction
    Task1: make the whole Solar System roating in reverse direction
    Task2: make the moon roating twice faster.
*/
...
static void display() {
    ...
    glRotatef(xmoon, 0, 1.0, 0.0);	     // Rotate
